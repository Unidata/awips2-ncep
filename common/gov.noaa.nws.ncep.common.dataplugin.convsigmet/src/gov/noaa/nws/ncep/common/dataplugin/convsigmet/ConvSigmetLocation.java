 ...
 * ConvsigmetLocation
 *
 * This java class defines the getters and setters for the convective sigmet
 * location table.
 *
 * <pre>
 *
...
@Entity
@Table(name = "convsigmet_location", indexes = {
        @Index(name = "convSigmetLocation_parentid_idex", columnList = "parentID") })
@DynamicSerialize
