...
@Entity
@Table(name = "ffg_precip", indexes = {
        @Index(name = "ffgP_parentid_idex", columnList = "parentID") })
@DynamicSerialize
public class FfgPrecip implements Serializable, ISerializableObject {
     ...
     * @return the parentID
     *
     *         public FfgRecord getParentID() { return parentID; }
     */
     ...
     *            the parentID to set
     *
     *            public void setParentID(FfgRecord parentID) { this.parentID =
     *            parentID; }
     */
