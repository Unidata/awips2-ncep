 ...
 * Mar 06, 2019 tgurney     Hibernate 5 @Index fix
 *
 * </pre>
 *
...
@Entity
@Table(name = "nonconvsigmet_location", indexes = {
        @Index(name = "nonConvSigmetLocation_parentid_idex", columnList = "parentID") })
@DynamicSerialize
public class NonConvSigmetLocation
