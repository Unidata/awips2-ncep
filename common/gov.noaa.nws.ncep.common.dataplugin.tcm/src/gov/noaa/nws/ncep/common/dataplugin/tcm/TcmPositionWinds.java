...
@Entity
@Table(name = "tcm_position_winds", indexes = {
        @Index(name = "tcmPosWinds_parentid_idex", columnList = "parentID") })
@DynamicSerialize
public class TcmPositionWinds implements Serializable, ISerializableObject {
    ...
    /**
     * @param drct
     *            the storm moving stormDrct to set
     */
    ...
    /**
     * @param sped
     *            the storm moving stormSped to set
     */
