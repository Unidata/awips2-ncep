...
import gov.noaa.nws.ncep.common.dataplugin.gempak.request.SurfaceDataRequest;
...
/**
 * Executes point data queries for station surface data under a single
 * timestamp.
 * 
 * <pre>
 * 
 ...
 * @version 1.0
 */
public class SurfaceDataRequestHandler implements
        IRequestHandler<SurfaceDataRequest> {
    ...
    /**
     * Accepts the passed in SurfaceDataRequest passed in by the
     ...
     */
    @Override
    public Map<String, Object> handleRequest(SurfaceDataRequest request)
            throws Exception {
