 ...
 * 08/21/2015   R7190       R. Reynolds  Modifications to handle mcidas area header info.
 * 
 * </pre>
 * 
 * @author tlee
...
public class McidasMapCoverageDao extends CoreDao {
     ...
     * @param mapId
     *            The Map ID
     * @return A McidasMapCoverage object with the corresponding ID. Null if not
     *         found.
     */
    ...
    /**
     * Retrieves all McIDAS map coverage windows for a given type. These types
     * include IR, Visible, and Water Vapor
     * 
     * @param type
    ...
    public List<McidasMapCoverage> queryByType(String type)
    ...
    public McidasMapCoverage getSatCoverage(Integer mapProjection, Integer nx,
            Integer ny, Float dx, Float dy, Float clon, Float stdlat1,
            Float stdlat2, Float lllat, Float lllon, Float urlat, Float urlon)
            throws DataAccessLayerException {
    ...
    public McidasMapCoverage getSatCoverage(Integer iproj, Integer nx,
        ...
        // if ( coverage == null )
        // System.out.println("COULDNT FIND Existing COVERAGE");
