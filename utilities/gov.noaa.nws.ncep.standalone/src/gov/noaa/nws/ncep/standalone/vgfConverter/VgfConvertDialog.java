...
public class VgfConvertDialog extends TitleAreaDialog {
    ...
    // private String in = "/export-1/cdbsrv/nawdev/nawips/gempak/data/vgf";
    // //"/export/cdbsrv/qzhou/work/data1";
    // private String out = NmapCommon.getLutsDir();
    // //"/export/cdbsrv/qzhou/work/data2";
    private String in = "";
        ...
        btOK.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent event) {
                ...
                if (s1.length() == 0 || s2.length() == 0) {
                    ...
                    try {
                        fileconverted = (new Convert()).convertMap(s1, s2, s3,
                                s4, "Default", "Default", "UNKNOWN", s5, false);
                    } catch (IOException e) {
                        System.out.println("The convertion failed.");
                        // e.printStackTrace();
                    } // File can handle it

                    setErrorMessage(fileconverted + " files are converted.  "
