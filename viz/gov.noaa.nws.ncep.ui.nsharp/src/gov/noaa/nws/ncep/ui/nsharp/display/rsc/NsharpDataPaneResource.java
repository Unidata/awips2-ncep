...
public class NsharpDataPaneResource extends NsharpAbstractPaneResource {
    ...
    private void drawPanel(IGraphicsTarget target, int pageOrderNumber,
        ...
        if (pageOrderNumber > NsharpConstants.PAGE_MAX_NUMBER
                || dsiplayPanelNumber > numberPagePerDisplay) {
            return;
        }
    ...
    private void drawPanel1(IGraphicsTarget target, Rectangle rect)
        ...
        //
        Rectangle2D strBD = target.getStringBounds(myfont, PAGE1TEXT1_FCST_STR
                + "XX");
        ...
        target.drawString(myfont, "PARCEL", startX, rect.y, 0.0,
                TextStyle.NORMAL, textColor,
                HorizontalAlignment.LEFT, VerticalAlignment.TOP, null);
        target.drawString(myfont, "CAPE", firstToken, rect.y, 0.0,
                TextStyle.NORMAL, textColor,
                HorizontalAlignment.LEFT, VerticalAlignment.TOP, null);
        target.drawString(myfont, "CIN", secondToken, rect.y, 0.0,
                TextStyle.NORMAL, textColor,
                HorizontalAlignment.LEFT, VerticalAlignment.TOP, null);
        ...
        for (int parcelNumber = 1; parcelNumber <= NsharpLibSndglib.PARCEL_MAX; parcelNumber++) {
            ...
            if(parcelNumber == NsharpLibSndglib.PARCELTYPE_MOST_UNSTABLE){
                NsharpWeatherDataStore.ParcelMiscParams parcelMiscs = weatherDataStore
                        .getParcelMiscParamsMap().get(parcelNumber);
            ...
            if (parcel != null && NsharpLibBasics.qc(parcel.getBplus())) {
                ...
                if(parcelNumber == currentParcel){
                    if (cape < 100){
                        textColor = NsharpConstants.color_brown;//Gemapk color 8, Brown
                    }
                    else if(cape < 500) {
                        textColor = NsharpConstants.color_darkorange;//Gemapk color 18, Dk Orange
                    }
                    else if(cape < 1000) {
                        textColor = NsharpConstants.color_apricot;//Gemapk color 10, Apricot
                    }
                    else if(cape < 2500) {
                        textColor = NsharpConstants.color_gold;//Gemapk color 19, Gold
                    }
                    else if(cape < 4000) {
                        textColor = NsharpConstants.color_red;// Gemapk color 2, Red
                    }
                    else {
                        textColor = NsharpConstants.color_magenta;//Gemapk color 7, Megenta
                    }
                }
                target.drawString(myfont,
                        String.format("%.0f", cape), firstToken,
                        curY, 0.0, TextStyle.NORMAL,
                        textColor, HorizontalAlignment.RIGHT,
            ...
            if (parcel != null && NsharpLibBasics.qc(parcel.getBminus())) {
                if(parcelNumber == currentParcel){
                    ...
                    if(cape  != NsharpLibSndglib.NSHARP_NATIVE_INVALID_DATA && cape <1){
                        ...
                        textColor = NsharpConstants.color_lawngreen;//Gemapk color 21
                    }
                    ...
                    if (cin < -100){
                        ...
                        textColor = NsharpConstants.color_darkgreen;//Gemapk color 23, Dk Green
                    }
                    else if(cin < -10) {
                        textColor = NsharpConstants.color_mdgreen;//Gemapk color 22, Md Green
                    }
                }
                target.drawString(myfont,
                        String.format("%.0f", parcel.getBminus()), secondToken,
                        curY, 0.0, TextStyle.NORMAL,
                        textColor, HorizontalAlignment.RIGHT,
                        VerticalAlignment.TOP, null);
            } else {
            ...
            // draw LCL
            if (parcel != null
                    && NsharpLibBasics.qc(NsharpLibBasics.ftom(parcel
                            .getLclAgl()))) {
            ...
            if (parcel != null && NsharpLibBasics.qc(parcel.getLi5())
                    && parcel.getLi5() < 100) {
                target.drawString(myfont,
                        String.format("%5.0f", parcel.getLi5()), forthToken,
                        curY, 0.0, TextStyle.NORMAL,
                        NsharpConstants.color_white, HorizontalAlignment.RIGHT,
                        VerticalAlignment.TOP, null);
            } else {
            ...
            if (parcel != null
                ...
                target.drawString(
                        myfont,
                        String.format("%.0fm",
                                NsharpLibBasics.ftom(parcel.getLfcAgl())),
            ...
            if (parcel != null && NsharpLibBasics.qc(parcel.getElAgl())) {
                target.drawString(myfont,
                        String.format("%.0f'", parcel.getElAgl()), sixthToken,
                        curY, 0.0, TextStyle.NORMAL,
                        NsharpConstants.color_white, HorizontalAlignment.RIGHT,
                        VerticalAlignment.TOP, null);
            } else {
        ...
        DrawableString str = new DrawableString("ABCDEF",
        ...
        if (NsharpLibBasics.qc(midRh)) {
            textStr = String.format("%.0f%c", midRh,
        ...
        if (NsharpLibBasics.qc(lowRh)) {
            textStr = String.format("%.0f%c", lowRh,
                    NsharpConstants.PERCENT_SYMBOL);
        } else {
            textStr = " M";
        }
        ...
        if (NsharpLibBasics.qc(sfcTo3kmLapseRate)) {
            textStr = String.format("%.0fC/%.1fC/km", sfcTo3kmTempDelta,
                    sfcTo3kmLapseRate);
        } else {
            textStr = " M";
        }
        ...
        if (NsharpLibBasics.qc(superCell)) {
            ...
            if (superCell < -0.45){
                textColor = NsharpConstants.color_cyan;//Gemapk color 6, Cyan
            }
        ...
        // 3km-6km Lapse rate
        float threeKmTo6kmTempDelta = weatherDataStore
                .getThreeKmTo6kmTempDelta();
        float threeKmTo6kmLapseRate = weatherDataStore
                .getThreeKmTo6kmLapseRate();
        if (NsharpLibBasics.qc(threeKmTo6kmLapseRate)) {
            textStr = String.format("%.0fC/%.1fC/km", threeKmTo6kmTempDelta,
                    threeKmTo6kmLapseRate);
        ...
        if (NsharpLibBasics.qc(cin)) {
            ...
            if (cin < 0.5){
                ...
                textColor = NsharpConstants.color_white;//Gemapk color 31, Dk Orange
            }
            else if(cin < 4){
                textColor = NsharpConstants.color_gold;//Gemapk color 19, Gold
            }
        ...
        float eight50To500mbTempDelta = weatherDataStore
                .getEight50To500mbTempDelta();
        float eight50To500mbLapseRate = weatherDataStore
                .getEight50To500mbLapseRate();
        if (NsharpLibBasics.qc(eight50To500mbTempDelta)
                && NsharpLibBasics.qc(eight50To500mbLapseRate)) {
            textStr = String.format("%.0fC/%.1fC/km", eight50To500mbTempDelta,
                    eight50To500mbLapseRate);
        } else {
            textStr = " M";
        }
        ...
        float sevenHundredTo500mbTempDelta = weatherDataStore
                .getSevenHundredTo500mbTempDelta();
        float sevenHundredTo500mbLapseRate = weatherDataStore
                .getSevenHundredTo500mbLapseRate();
        if (NsharpLibBasics.qc(sevenHundredTo500mbTempDelta)
                && NsharpLibBasics.qc(sevenHundredTo500mbLapseRate)) {
            textStr = String.format("%.0fC/%.1fC/km",
                    sevenHundredTo500mbTempDelta, sevenHundredTo500mbLapseRate);
        } else {
            textStr = " M";
        }
    ...
    private void drawPanel2(IGraphicsTarget target, Rectangle rect)
        ...
        for (int i = 0; i < NsharpWeatherDataStore.STORM_MOTION_TYPE_STR.length; i++) {
            RGB textColor = NsharpConstants.color_white;
            if (NsharpWeatherDataStore.STORM_MOTION_TYPE_STR[i]
                    .equals("Eff Inflow")||
                    NsharpWeatherDataStore.STORM_MOTION_TYPE_STR[i]
                            .equals("Eff Shear(EBWD)")) {
                textColor = NsharpConstants.color_yellow;
            }
            // draw row header
            target.drawString(myfont,
                    NsharpWeatherDataStore.STORM_MOTION_TYPE_STR[i], startX,
                    curY, 0.0, TextStyle.NORMAL, textColor,
                    HorizontalAlignment.LEFT, VerticalAlignment.TOP, null);
            ...
            if (NsharpWeatherDataStore.STORM_MOTION_TYPE_STR[i]
                ...
                NsharpWeatherDataStore.ParcelMiscParams parcelMiscs = weatherDataStore
                        .getParcelMiscParamsMap().get(this.currentParcel);
                if (parcelMiscs != null) {
                ...
                windShear = weatherDataStore.getStormTypeToWindShearMap().get(
                        NsharpWeatherDataStore.STORM_MOTION_TYPE_STR[i]);
            ...
            // draw mean wind
            if (meanwindComp != null
                    && NsharpLibBasics.qc(meanwindComp.getWdir())
                    && NsharpLibBasics.qc(meanwindComp.getWspd())) {
                textStr = String.format("%.0f/%.0f", meanwindComp.getWdir(),
                        meanwindComp.getWspd());
            } else {
                textStr = "M";
            }
            ...
            if (srMeanwindComp != null
                    && NsharpLibBasics.qc(srMeanwindComp.getWdir())
                    && NsharpLibBasics.qc(srMeanwindComp.getWspd())) {
                textStr = String.format("%.0f/%.0f", srMeanwindComp.getWdir(),
                        srMeanwindComp.getWspd());
            } else {
                textStr = "M";
            }
        ...
        if (parcel != null && NsharpLibBasics.qc(parcel.getBrnShear()))
            textStr = String.format("%.0f m%c/s%c", parcel.getBrnShear(),
                    NsharpConstants.SQUARE_SYMBOL,
                    NsharpConstants.SQUARE_SYMBOL);
        else {
            textStr = "  M";
        ...
        if (NsharpLibBasics.qc(windComp.getWdir())
                && NsharpLibBasics.qc(windComp.getWspd())) {
            textStr = String.format("%.0f/%.0f kt", windComp.getWdir(),
                    windComp.getWspd());
        } else {
            textStr = " M";
        }
        ...
        // Corfidi Downshear @[0]
        WindComponent[] corfidiWindComp = weatherDataStore
                .getCofidiShearWindComp();
        textStr = String.format("%.0f/%.0f kt", corfidiWindComp[0].getWdir(),
                corfidiWindComp[0].getWspd());
        ...
        // Corfidi Upshear @[1]
        textStr = String.format("%.0f/%.0f kt", corfidiWindComp[1].getWdir(),
                corfidiWindComp[1].getWspd());
        ...
        // Bunkers Right @ [0]
        WindComponent[] bunkerStormWndComp = weatherDataStore
                .getBunkersStormMotionWindComp();
        textStr = String.format("%.0f/%.0f kt",
                bunkerStormWndComp[0].getWdir(),
                bunkerStormWndComp[0].getWspd());
        ...
        // Bunkers Left @ [1]
        textStr = String.format("%.0f/%.0f kt",
                bunkerStormWndComp[1].getWdir(),
                bunkerStormWndComp[1].getWspd());
     ...
     // the following color setting is based on show_shear_new() at xwvid3.c
        ...
        List<LineStroke> barb = WindBarbFactory.getWindGraphics(
                (double) NsharpLibBasics.i_wspd(
                        soundingLys,
                        NsharpLibBasics.i_pres(soundingLys,
                                NsharpLibBasics.msl(soundingLys, 1000))),
                (double) NsharpLibBasics.i_wdir(
                        soundingLys,
                        NsharpLibBasics.i_pres(soundingLys,
                                NsharpLibBasics.msl(soundingLys, 1000))));
        if (barb != null) {
    ...
    private void drawPanel3(IGraphicsTarget target, Rectangle rect)
        ...
        layerPressure = NsharpWeatherDataStore.parcelToLayerPressMap
                .get(currentParcel);
        ...
        if (parcel != null) {
            ...
            textStr = String.format(textStr, (int) parcel.getLplpres(),
                    (int) parcel.getLpltemp(), (int) parcel.getLpldwpt(),
                    (int) NsharpLibBasics.ctof(parcel.getLpltemp()),
            ...
            for (int i = 0; i < splitedStr.length; i++) {
                target.drawString(myfont, splitedStr[i], rect.x + i
                        * rect.width / 4, curY, 0.0, TextStyle.NORMAL,
                        NsharpConstants.color_white, HorizontalAlignment.LEFT,
                        VerticalAlignment.TOP, null);
            }
        } else {
            target.drawString(myfont, PARCEL_LPL_MISSING, rect.x, curY, 0.0,
                    TextStyle.NORMAL, NsharpConstants.color_white,
                    HorizontalAlignment.LEFT, VerticalAlignment.TOP, null);
        }
        ...
        if (parcel != null && NsharpLibBasics.qc(parcel.getLimax())) {
            ...
            textStr = String.format(textStr, parcel.getLimax(),
                    parcel.getLimaxpres());
        } else {
        ...
        if (parcel != null && NsharpLibBasics.qc(parcel.getCap())) {
            ...
            textStr = String.format(textStr, parcel.getCap(),
                    parcel.getCappres());
        } else {
        ...
        if (parcel != null && NsharpLibBasics.qc(parcel.getLclpres())
            ...
            textStr = String.format(textStr, parcel.getLclpres(),
                    parcel.getLclAgl());
        } else {
        ...
        if (parcel != null && NsharpLibBasics.qc(parcel.getLfcpres())
            ...
            textStr = String.format(textStr, parcel.getLfcpres(),
                    parcel.getLfcAgl(), parcel.getLfcTemp());
        } else {
        ...
        if (parcel != null && NsharpLibBasics.qc(parcel.getElpres())
                && NsharpLibBasics.qc(parcel.getElAgl())
                && NsharpLibBasics.qc(parcel.getElTemp())) {
            textStr = PARCEL_EL_LINE_;
            textStr = String.format(textStr, parcel.getElpres(),
                    parcel.getElAgl(), parcel.getElTemp());
        } else {
        ...
        if (parcel != null && NsharpLibBasics.qc(parcel.getMplpres())
                && NsharpLibBasics.qc(parcel.getMplAgl())) {
            textStr = PARCEL_MPL_LINE_;
            textStr = String.format(textStr, parcel.getMplpres(),
                    parcel.getMplAgl());
        } else {
    ...
    private void drawPanel4(IGraphicsTarget target, Rectangle rect)
        ...
        if (NsharpLibBasics.qc(meanRh)) {
            ...
            textStr = String.format(textStr, meanRh,
                    NsharpConstants.PERCENT_SYMBOL);
        } else {
        ...
        if (NsharpLibBasics.qc(sevenHundredTo500mbTempDelta)
            ...
            textStr = String.format(textStr, sevenHundredTo500mbTempDelta,
        ...
        if (NsharpLibBasics.qc(eight50To500mbTempDelta)
            ...
            textStr = String.format(textStr, eight50To500mbTempDelta,
                    eight50To500mbLapseRate);
        } else {
        ...
        for (int parcelNumber = 1; parcelNumber <= NsharpLibSndglib.PARCEL_MAX; parcelNumber++) {
            ...
            if (parcel != null && NsharpLibBasics.qc(parcel.getLi5())
                    && parcel.getLi5() < 100) {
                target.drawString(myfont,
                        String.format(li + "%5.0f", parcel.getLi5()), x, curY,
                        0.0, TextStyle.NORMAL, NsharpConstants.color_white,
                        HorizontalAlignment.LEFT, VerticalAlignment.TOP, null);
    ...
    private void drawPanel5(IGraphicsTarget target, Rectangle rect)
        ...
        if (!NsharpLibBasics.qc(weatherDataStore.getHeight975()))
            ...
            textStr = String.format(textStr, weatherDataStore.getHeight975(),
                    weatherDataStore.getTemp975());
        }
        splitedStr = textStr.split("_", -1);
        for (int i = 0; i < splitedStr.length; i++) {
            target.drawString(myfont, splitedStr[i], rect.x + i * rect.width
        ...
        if (NsharpLibBasics.qc(weatherDataStore.getSfcLayer().getPressure())
                && NsharpLibBasics.qc(weatherDataStore.getSfcLayer()
                        .getGeoHeight())
                && NsharpLibBasics.qc(weatherDataStore.getSfcLayer()
                        .getTemperature())) {
            textStr = NsharpNativeConstants.OPC_SURFACE_LINE_;
            textStr = String.format(textStr, weatherDataStore.getSfcLayer()
                    .getPressure(), weatherDataStore.getSfcLayer()
                    .getGeoHeight(), weatherDataStore.getSfcLayer()
                    .getTemperature());
        } else {
        ...
        if (NsharpLibBasics.qc(weatherDataStore.getTemp975())
            ...
            textStr = String.format(textStr, weatherDataStore.getTemp975()
                    - weatherDataStore.getSfcLayer().getTemperature());
        } else {
        ...
        if (NsharpLibBasics.qc(weatherDataStore.getLowestInvHeight())) {
            ...
            textStr = String.format(textStr,
                    weatherDataStore.getLowestInvHeight());
        } else {
        ...
        if (NsharpLibBasics.qc(weatherDataStore.getLowestInvPressure())) {
            ...
            textStr = String.format(textStr,
                    weatherDataStore.getLowestInvPressure());
        } else {
        ...
        if (NsharpLibBasics.qc(weatherDataStore.getLowestInvTempChange())) {
            ...
            textStr = String.format(textStr,
                    weatherDataStore.getLowestInvTempChange());
        } else {
    ...
    private void drawPanel6(IGraphicsTarget target, Rectangle rect)
        ...
        if (NsharpLibBasics.qc(mixHgt.getMh_drct())
                && NsharpLibBasics.qc(mixHgt.getMh_sped())) {
            textStr = NsharpNativeConstants.OPC_TOPMIXLAYER_LINE;
            textStr = String.format(textStr, (int) mixHgt.getMh_drct(),
                    NsharpConstants.DEGREE_SYMBOL, (int) (mixHgt.getMh_sped()));
        } else {
        ...
        if (NsharpLibBasics.qc(mixHgt.getMh_drct_max())
                && NsharpLibBasics.qc(mixHgt.getMh_sped_max())) {
            textStr = NsharpNativeConstants.OPC_MIXLAYERMAX_LINE;
            textStr = String.format(textStr, (int) mixHgt.getMh_drct_max(),
        ...
        if (NsharpLibBasics.qc(mixHgt.getMh_dC())
                && NsharpLibBasics.qc(mixHgt.getMh_lr())) {
            textStr = NsharpNativeConstants.OPC_LAYER_LAPSE_LINE;
            textStr = String.format(textStr, mixHgt.getMh_dC(),
                    mixHgt.getMh_lr());
        } else {
    ...
    private void drawPanel7(IGraphicsTarget target, Rectangle rect)
        ...
        if (NsharpLibBasics.qc(smSpd) && NsharpLibBasics.qc(smDir)) {
            ...
            textStr = String.format(textStr, smDir,
                    NsharpConstants.DEGREE_SYMBOL, smSpd,
        ...
        Helicity helicity = weatherDataStore.getStormTypeToHelicityMap().get(
                NsharpWeatherDataStore.STORM_MOTION_TYPE_STR[1]);
        ...
        if (NsharpLibBasics.qc(helicity.getPosHelicity())
            ...
            textStr = String.format(textStr, helicity.getPosHelicity(),
                    helicity.getNegHelicity(), totHeli,
                    NsharpConstants.SQUARE_SYMBOL,
                    NsharpConstants.SQUARE_SYMBOL);
        ...
        helicity = weatherDataStore.getStormTypeToHelicityMap().get(
                NsharpWeatherDataStore.STORM_MOTION_TYPE_STR[2]);
        totHeli = helicity.getTotalHelicity();
        if (NsharpLibBasics.qc(helicity.getPosHelicity())
                && NsharpLibBasics.qc(helicity.getNegHelicity())) {
        ...
        if (helicity != null && NsharpLibBasics.qc(helicity.getPosHelicity())
            ...
            textStr = String.format(textStr, helicity.getPosHelicity(),
                    helicity.getNegHelicity(), helicity.getTotalHelicity(),
                    NsharpConstants.SQUARE_SYMBOL,
                    NsharpConstants.SQUARE_SYMBOL);
        } else {
        ...
        WindComponent srMeanwindComp = weatherDataStore
        ...
        if (NsharpLibBasics.qc(srMeanwindComp.getWdir())) {
            ...
            textStr = String.format(textStr, srMeanwindComp.getWdir(),
                    srMeanwindComp.getWspd(),
    ...
    private void drawPanel8(IGraphicsTarget target, Rectangle rect)
        ...
        // mean wind at 0-6 km
        WindComponent windComp = weatherDataStore.getStormTypeToMeanWindMap()
                .get("SFC-6km");
        if (NsharpLibBasics.qc(windComp.getWdir())
                && NsharpLibBasics.qc(windComp.getWspd())) {
            textStr = NsharpNativeConstants.MEANWIND_SFC6KM_LINE;
            textStr = String.format(textStr, windComp.getWdir(),
                    windComp.getWspd(), NsharpConstants.KnotsToMetersPerSecond
                            * windComp.getWspd());
        } else {
        ...
        if (windComp != null && NsharpLibBasics.qc(windComp.getWdir())
                && NsharpLibBasics.qc(windComp.getWspd())) {
        ...
        float windShear = weatherDataStore.getStormTypeToWindShearMap().get(
                "SFC-3km");
        if (NsharpLibBasics.qc(windShear)) {
            textStr = NsharpNativeConstants.SHEAR_LOW_3KM_LINE;
            textStr = String.format(textStr, windShear,
                    NsharpLibBasics.kt_to_mps(windShear),
    ...
    private void drawPanel9(IGraphicsTarget target, Rectangle rect)
        ...
        // cap
        if (parcel != null && NsharpLibBasics.qc(parcel.getCap())
                && NsharpLibBasics.qc(parcel.getCappres())) {
        ...
        // However, to be consistent with legacy Nsharp, we compute it with default value
        float hel = weatherDataStore.getStormTypeToHelicityMap()
                .get(NsharpWeatherDataStore.STORM_MOTION_TYPE_STR[2])
                .getTotalHelicity();
        ...
        if (NsharpLibBasics.qc(weatherDataStore.getRogashRainRate())) {
            ...
            textStr = String.format(textStr,
                    weatherDataStore.getRogashRainRate());
        } else {
    ...
    private void drawPanel10(IGraphicsTarget target, Rectangle rect)
        ...
        if (NsharpLibBasics.qc(weatherDataStore.getMidLvlRH500To700())) {
            ...
            textStr = String.format(textStr,
                    weatherDataStore.getMidLvlRH500To700(),
                    NsharpConstants.PERCENT_SYMBOL);
        } else {
        ...
        ParcelMiscParams parcelMiscParams = weatherDataStore
                .getParcelMiscParamsMap().get(currentParcel);
        // EL Storm
        if (parcelMiscParams != null
                && NsharpLibBasics.qc(parcelMiscParams.getSrWindCompEl()
                        .getWspd())) {
            textStr = NsharpNativeConstants.SEVERE_ELSTORM_LINE;
            textStr = String.format(textStr, parcelMiscParams.getSrWindCompEl()
                    .getWspd());
        } else {
        ...
        // CHI1
        if (parcelMiscParams != null
                && NsharpLibBasics.qc(parcelMiscParams.getChi1())) {
        ...
        // CHI2
        if (parcelMiscParams != null
                && NsharpLibBasics.qc(parcelMiscParams.getChi2())) {
        ...
        if (NsharpLibBasics.qc(weatherDataStore.getAvgWetbulbTemp())) {
            ...
            textStr = String.format(textStr,
                    weatherDataStore.getAvgWetbulbTemp(),
                    NsharpConstants.DEGREE_SYMBOL);
        } else {
        ...
        // Low SRW Sfc
        if (parcelMiscParams != null
                && NsharpLibBasics.qc(parcelMiscParams
                        .getSrMeanWindCompSfcToLfc().getWspd())) {
            textStr = NsharpNativeConstants.SEVERE_LOWSRWSFC_LINE;
            textStr = String.format(textStr, parcelMiscParams
                    .getSrMeanWindCompSfcToLfc().getWspd());
        } else {
        ...
        if (parcelMiscParams != null
                && NsharpLibBasics.qc(parcelMiscParams
                        .getSrMeanWindCompLfcToLFCP4km().getWspd())) {
        ...
        if (parcelMiscParams != null
                && NsharpLibBasics.qc(parcelMiscParams
                        .getSrMeanWindCompElM4kmToEl().getWspd())) {
    ...
    private void drawPanel11(IGraphicsTarget target, Rectangle rect)
        ...
        if (paneConfigurationName.equals(NsharpConstants.PANE_LITE_D2D_CFG_STR)
            ...
            for (int parcelNumber = 1; parcelNumber <= NsharpLibSndglib.PARCEL_D2DLITE_MAX; parcelNumber++) {
                ...
                if (parcel != null && NsharpLibBasics.qc(parcel.getBplus())) {
                    str3.setText(String.format("%.0f", parcel.getBplus()),
                            NsharpConstants.color_white);
                } else {
                ...
                if (parcel != null && NsharpLibBasics.qc(parcel.getBminus())) {
                    str5.setText(String.format("%.0f", parcel.getBminus()),
                            NsharpConstants.color_white);
                } else {
                ...
                if (parcel != null && NsharpLibBasics.qc(parcel.getLclpres())
                        && NsharpLibBasics.qc(parcel.getLclAgl())) {
                    str7.setText(String.format("%5.0fmb", parcel.getLclpres()),
                            NsharpConstants.color_white);
                    str9.setText(String.format("%7.0f'", parcel.getLclAgl()),
                            NsharpConstants.color_white);
                } else {
                ...
                if (parcel != null && NsharpLibBasics.qc(parcel.getLfcpres())
                        && NsharpLibBasics.qc(parcel.getLfcAgl())) {
                    str11.setText(
                            String.format("%5.0fmb", parcel.getLfcpres()),
                            NsharpConstants.color_white);
                    str13.setText(String.format("%7.0f'", parcel.getLfcAgl()),
                            NsharpConstants.color_white);
                } else {
            ...
            for (int parcelNumber = 1; parcelNumber <= NsharpLibSndglib.PARCEL_D2DLITE_MAX; parcelNumber++) {
                ...
                if (parcel != null && NsharpLibBasics.qc(parcel.getLclpres())
                        && NsharpLibBasics.qc(parcel.getLclAgl())) {
                    str5.setText(String.format("%5.0f", parcel.getLclpres()),
                            NsharpConstants.color_white);
                    str7.setText(String.format("%7.0f", parcel.getLclAgl()),
                            NsharpConstants.color_white);
                } else {
                    str5.setText("M", NsharpConstants.color_white);
                    str7.setText("M", NsharpConstants.color_white);
                ...
                if (parcel != null && NsharpLibBasics.qc(parcel.getBminus())) {
                    str9.setText(String.format("%.0f", parcel.getBminus()),
                            NsharpConstants.color_white);
                } else {
                    str9.setText("M", NsharpConstants.color_white);
                }
                ...
                if (parcel != null && NsharpLibBasics.qc(parcel.getLfcpres())
                        && NsharpLibBasics.qc(parcel.getLfcAgl())) {
                    str11.setText(String.format("%5.0f", parcel.getLfcpres()),
                            NsharpConstants.color_white);
                    str13.setText(String.format("%7.0f", parcel.getLfcAgl()),
                            NsharpConstants.color_white);
                } else {
        ...
        if (parcel != null && NsharpLibBasics.qc(brnShear)) {
            textStr = String.format("  %.0f m%c/s%c", brnShear,
                    NsharpConstants.SQUARE_SYMBOL,
                    NsharpConstants.SQUARE_SYMBOL);
        } else {
            textStr = "M";
        ...
        str5.setCoordinates(startX, curY);
        float dir = weatherDataStore.getBunkersStormMotionWindComp()[0]
                .getWdir();
        float spd = weatherDataStore.getBunkersStormMotionWindComp()[0]
                .getWspd();
        ...
        Helicity helicity = weatherDataStore.getStormTypeToHelicityMap().get(
                NsharpWeatherDataStore.STORM_MOTION_TYPE_STR[0]);
        float totHeli = helicity.getTotalHelicity();
        if (NsharpLibBasics.qc(helicity.getPosHelicity())
                && NsharpLibBasics.qc(helicity.getPosHelicity())) {
