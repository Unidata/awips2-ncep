...
public class AvnTextAttrDlg extends AttrDlg implements IAvnText {
    ...
    // public static final String[] FontName = new String[]{ "Courier",
    // "Helvetica", "Times" };
    public static final String[] FontName = new String[] { "Courier",
            "Nimbus Sans L", "Liberation Serif" };

    public static final String[] BoxName = new String[] { "Normal", "Boxed",
            "Blanked", "Outline" };

    private static final String[] ICING_LIST = new String[] { "ICING_00",
            "ICING_01", "ICING_02", "ICING_03", "ICING_04", "ICING_05",
            "ICING_06", "ICING_07", "ICING_08", "ICING_09", "ICING_10" };
    ...
    private static enum ChkBox {
        TYPE, TOP, BOTTOM, SIZE, FONT, STYLE, JUST, COLOR, SYMBOL
    };
    ...
    /*
     * Configures the AvnTextAttrDlg dialog based on the selected Aviation Text
     * Type
     */
    private void updateDialog(AviationTextType atype) {
        ...
        /*
         * When multi-selecting, disable bottom and symbol if their check boxes
         * are not set.
         */
    ...
    /**
     * Get a list of widgets that should be disabled for the fgiven avn text
     * type
     * 
     * @param Aviation
     *            Text type
    ...
    private void createTypeAttr() {
        ...
        chkBox[ChkBox.TYPE.ordinal()].setLayoutData(new GridData(CHK_WIDTH,
                CHK_HEIGHT + 5));
        chkBox[ChkBox.TYPE.ordinal()]
    ...
    private void createTopAttr() {
        ...
        chkBox[ChkBox.TOP.ordinal()].setLayoutData(new GridData(CHK_WIDTH,
                CHK_HEIGHT + 5));
        chkBox[ChkBox.TOP.ordinal()]
                .addSelectionListener(new SelectionAdapter() {
    ...
    private void createBottomAttr() {
        ...
        chkBox[ChkBox.BOTTOM.ordinal()].setLayoutData(new GridData(CHK_WIDTH,
                CHK_HEIGHT + 5));
        chkBox[ChkBox.BOTTOM.ordinal()]
                .addSelectionListener(new SelectionAdapter() {
    ...
    private void createJustAttr() {
        ...
        chkBox[ChkBox.JUST.ordinal()].setLayoutData(new GridData(CHK_WIDTH,
                CHK_HEIGHT + 5));
        chkBox[ChkBox.JUST.ordinal()]
                .addSelectionListener(new SelectionAdapter() {
    ...
    private void createSymbolAttr() {
        ...
        chkBox[ChkBox.SYMBOL.ordinal()].setLayoutData(new GridData(CHK_WIDTH,
                CHK_HEIGHT));
        chkBox[ChkBox.SYMBOL.ordinal()]
                .addSelectionListener(new SelectionAdapter() {
