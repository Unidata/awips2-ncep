...
public class MidLevelCloudAttrDlg extends AttrDlg implements IMidCloudText {
    ...
    /**
     * Creates an aviation mid level cloud text attribute dialog if the dialog
     * does not exist and returns the instance. If the dialog exists, return the
     * instance.
     * 
     * @param parShell
     * @return
    ...
    private void initializeComponents() {
        ...
        /*
         * Create cloud, turbulence, icing, and tstorm widgets, if not in
         * multiselect mode
         */
     ...
     * 
     * typeLabel = new Label( top, SWT.NONE ); typeLabel.setText(
     * "Cloud Amount:" );
     * 
     * Composite c2 = new Composite( top, SWT.NONE ); c2.setLayout(new
     * GridLayout(4,true) );
     * 
     * for ( CloudAmounts type : CloudAmounts.values() ) { Button btn = new
     * Button( c2, SWT.CHECK ); btn.setText(type.toString());
    ...
    public boolean hasIcing() {
        if (icingLevel.getText() == null || icingLevel.getText().isEmpty())
            return false;
        else
            return true;
    }
    ...
    public boolean hasTstorm() {
        if (tstormLevel.getText() == null || tstormLevel.getText().isEmpty())
            return false;
        else
            return true;
    }
    ...
    public boolean hasTurbulence() {
        if (turbLevel.getText() == null || turbLevel.getText().isEmpty())
            return false;
        else
            return true;
    }
