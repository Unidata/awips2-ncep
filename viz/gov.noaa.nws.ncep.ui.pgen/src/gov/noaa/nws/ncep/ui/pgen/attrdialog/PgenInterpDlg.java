 ...
 * 01/24/19     7716        K. Sunil    Add close button in the dialog.
 * </pre>
 *
 * @author
 * @version 1
...
public class PgenInterpDlg extends AttrDlg {
    ...
    private static PgenInterpDlg INSTANCE = null;

    private PgenInterpolationTool interpolationTool = null;
    ...
    public void createButtonsForButtonBar(Composite parent) {
        ...
        this.getButton(INTERP_ID)
                .setLayoutData(new GridData(ctrlBtnWidth + 40, ctrlBtnHeight));
    ...
    /**
     * Specifies the interpolation tool to use and enables the "Interpolate"
     * button
     * 
     * @param tool
    ...
    /**
     * An SWT VerifyListener that checks to make sure the only text input
     * allowed is a numeric digit, backspace, or delete character.
     * 
     * @author sgilbert
     *
     */
    class DigitVerifyListener implements VerifyListener {
        ...
        public void verifyText(VerifyEvent e) {
            ...
            if (Character.isDigit(e.character) || e.character == BACKSPACE
                    || e.character == DELETE) {
                e.doit = true;
            } else {
                e.doit = false;
