...
public class CWSFormatterDlg extends CaveSWTDialog {
    ...
    private void createCWSControls() {
        ...
        daySpinner.setMaximum(calendar.getLeastMaximum(Calendar.DAY_OF_MONTH));
    ...
    private void createProductTextBox() {
        ...
        productTxt.addVerifyListener(new VerifyListener() {
            ...
            public void verifyText(VerifyEvent e) {
                ...
                if (productTxt.isFocusControl()
                        && productTxt.getCaretLineNumber() < 2) {
                    e.doit = false;
                }
            }
        });
    ...
    private void createNewText() {
        ...
        output.append("FAUS20 ").append(cwaConfigs.getKcwsuId()).append(" ")
        ...
        productTxt.setText(output.toString());
    }
    ...
    private void createPreviousText() {
        ...
        String wmoHeader = "FAUS20  " + cwaConfigs.getKcwsuId();
        ...
        output.append(wmoHeader).append(" ").append(startDateTime)
                .append(" \n");
        output.append(cwaConfigs.getCwsuId()).append(" MIS ").append(seriesStr)
                .append(" VALID ");
        output.append(startDateTime).append("-").append(endDateTime)
        ...
        this.productTxt.setText(output.toString());
    }
