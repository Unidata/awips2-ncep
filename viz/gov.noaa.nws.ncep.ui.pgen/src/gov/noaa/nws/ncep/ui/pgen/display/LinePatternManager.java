...
/**
 * This class maintains a HashMap of defined Line Patterns that can be applied
 * to a multi-point line path.
 * <P>
 * This class is implemented as a singleton, and the predefined Line Patterns
 * are constructed when the instance is created. After the internal patterns are
 * loaded, others can be read in from an XML file if it exists.
 * 
...
public class LinePatternManager {
    ...
    /**
     * A map of the available Line Patterns with a descriptive String as the
     * key.
     */
    private HashMap<String, LinePattern> patternMap;

    private static final IUFStatusHandler logger = UFStatus
            .getHandler(LinePatternManager.class);
    ...
    private void loadInternal() {
        ...
        lp = new LinePattern("Line with open arrow head", true,
                ArrowHeadType.OPEN);
        patternMap.put("POINTED_ARROW", lp);

        lp = new LinePattern("Line with closed arrow head", true,
        ...
        lp.addSegment(new PatternSegment(0, PatternType.CIRCLE_FILLED, 0, 8, 0,
                false));
        ...
        lp = new LinePattern("Dashed Line with open arrow head", true,
                ArrowHeadType.OPEN);
        lp.addSegment(new PatternSegment(8, PatternType.LINE, 0, 0, 0, false));
        ...
        lp = new LinePattern("Dashed Line with filled arrow head", true,
                ArrowHeadType.FILLED);
        lp.addSegment(new PatternSegment(8, PatternType.LINE, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(6, PatternType.BLANK, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(8, PatternType.LINE, 0, 0, 0, false));
        ...
        lp.addSegment(new PatternSegment(8, PatternType.ARC_180_DEGREE, 0, 2,
                0, false));
        lp.addSegment(new PatternSegment(8, PatternType.ARC_180_DEGREE, 0, 2,
                0, true));
        ...
        lp.addSegment(new PatternSegment(8, PatternType.ARC_180_DEGREE, 0, 8,
                0, false));
        patternMap.put("SCALLOPED", lp);

        lp = new LinePattern("Alternating Angled Ticks", false, null);
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(4, PatternType.ARC_90_DEGREE, 0, 1, 0,
                false));
        lp.addSegment(new PatternSegment(8, PatternType.LINE, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(4, PatternType.ARC_90_DEGREE, 0, 1, 0,
                true));
        ...
        lp.addSegment(new PatternSegment(4, PatternType.CIRCLE_FILLED, 0, 8, 0,
                false));
        lp.addSegment(new PatternSegment(2, PatternType.BLANK, 0, 0, 0, false));
        ...
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(6,
                PatternType.ARC_270_DEGREE_WITH_LINE, 0, 2, 0, false));
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        ...
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(2, PatternType.BLANK, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(6, PatternType.ARC_270_DEGREE, 0, 2,
                0, false));
        lp.addSegment(new PatternSegment(2, PatternType.BLANK, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        ...
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(8, PatternType.ARC_180_DEGREE_FILLED,
                0, 8, 0, true));
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        ...
        lp.addSegment(new PatternSegment(8, PatternType.ARC_180_DEGREE_CLOSED,
                0, 8, 0, false));
        ...
        lp = new LinePattern("Filled Box-Open Box with filled arrow head",
                true, ArrowHeadType.FILLED);
        lp.addSegment(new PatternSegment(4, PatternType.BOX_FILLED, 0, 0, 2,
                false));
        ...
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(2, PatternType.BLANK, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(4, PatternType.X_PATTERN, 0, 0, 2,
                false));
        lp.addSegment(new PatternSegment(2, PatternType.BLANK, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        ...
        lp = new LinePattern("Line-Circle-Line with filled arrow head", true,
                ArrowHeadType.FILLED);
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(4, PatternType.CIRCLE, 0, 8, 0, false));
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        ...
        lp = new LinePattern("Line-Filled-Circle-Line with filled arrow head",
                true, ArrowHeadType.FILLED);
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(4, PatternType.CIRCLE_FILLED, 0, 8, 0,
                false));
        ...
        lp.addSegment(new PatternSegment(1, PatternType.DOUBLE_LINE, 0, 0, 2,
                false));
        patternMap.put("DOUBLE_LINE", lp);

        lp = new LinePattern("Z-Line", false, null);
        lp.addSegment(new PatternSegment(8, PatternType.Z_PATTERN, 0, 0, 2,
                false));
        ...
        lp.addSegment(new PatternSegment(12, PatternType.LINE, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(8, PatternType.ARROW_HEAD, 0, 2, 0,
                false));
    ...
    public void savePatternsToFile(String filename) {
        ...
        try {
            // RTS utility: SerializationUtil.jaxbMarshalToXmlFile(lpm,
            // filename);
            /*
             * Set JAXB Marshaling context and properties
             */
            JAXBContext context = JAXBContext.newInstance(
                    LinePatternList.class, LinePatternMapEntry.class);
            ...
            logger.error("savePatternsToFile(): ", e);
        } finally {
            if (writer != null)
                writer.close();
        }
    ...
    /**
     * Uses JAXB to unmarshal a list of LinePatterns from an XML file, and load
     * them into the internal HashMap.
     * 
     * @param filename
     *            input XML filename
     */
    public void loadPatternsFromFile(String filename) {
        ...
        try {
            // RTS utility: instance = (LinePatternManager)
            // SerializationUtil.jaxbUnmarshalFromXmlFile(filename);
            JAXBContext context = JAXBContext
                    .newInstance(LinePatternList.class);
            ...
            for (LinePatternMapEntry entry : lpl.getPatternList()) {
                ...
                tmpLP.setBlankOrLine(tmpBlankOrLine);

                patternMap.put(entry.getPatternId(), tmpLP);
            }

        } catch (Exception e) {
            logger.error("loadPatternsFromFile(): ", e);
        }
