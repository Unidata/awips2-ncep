...
@ElementOperations({ Operation.CONNECT, Operation.COPY_MOVE,
        ...
        Operation.DELETE_POINT, Operation.ADD_POINT, Operation.MODIFY })
public class Jet extends DECollection {
    ...
    public void setSnapTool(IJetTools snapTool) {
        ...
        if (this.snapTool == null) {
            ...
            while (it.hasNext()) {
                ...
                if (de instanceof JetText && ((JetText) de).getLatLonFlag()) {

                    // when elements are loaded from XML files, the locations
                    // of fl texts are lat/lon pairs,
                    // so they need to be converted to relative locations to the
                    // barbs.
                    // Note: Does not go through here anymore since the lat/lon
                    // are reset in product converter.
     ...
     *
     */
    @ElementOperations({ Operation.CONNECT, Operation.DELETE_PART,
            Operation.DELETE_POINT, Operation.MODIFY })
    public class JetLine extends Line {
        ...
        public JetLine(Coordinate[] range, Color[] colors, float lineWidth,
            ...
            super(range, colors, lineWidth, sizeScale, closed, filled,
                    linePoints, smoothFactor, fillPattern, pgenCategory,
                    pgenType);
        }
    ...
    public class JetBarb extends Vector {
         ...
         * @param pgenType
         */
        public JetBarb(Coordinate[] range, Color[] colors, float lineWidth,
                double sizeScale, Boolean clear, Coordinate location,
                VectorType vc, double speed, double direction,
                double arrowHeadSize, boolean directionOnly,
                String pgenCategory, String pgenType) {

            super(range, colors, lineWidth, sizeScale, clear, location, vc,
                    speed, direction, arrowHeadSize, directionOnly,
        ...
        /**
         * Return the flight level text of the barb. It can be null.
         *
         * @return
         */
        public JetText getFlightLvl() {
            DECollection windInfo = (DECollection) parent;
            Iterator<AbstractDrawableComponent> it = windInfo
    ...
    public class JetHash extends Vector {
         ...
         * @param pgenType
         */
        public JetHash(Coordinate[] range, Color[] colors, float lineWidth,
                double sizeScale, Boolean clear, Coordinate location,
                VectorType vc, double speed, double direction,
                double arrowHeadSize, boolean directionOnly,
                String pgenCategory, String pgenType) {
    ...
    public class JetText extends Text {
         ...
         * @param position
         *            - location specifying where to display the text String
         * @param rotation
         *            - display text at this rotation angle relative to +X
         *            direction.
         * @param rotationRelativity
         *            - rotation angle is relative to North or Screen
         *            coordinates
         * @see gov.noaa.nws.ncep.ui.pgen.display.IText.TextRotation
         * @param text
         *            The text Strings to display. The text strings in each
         *            array element are displayed on a different line
         * @param style
         *            The font style to use. @see
         *            gov.noaa.nws.ncep.ui.pgen.display.IText.FontStyle
         * @param textColor
        ...
        public JetText(Coordinate[] range, String fontName, float fontSize,
                ...
                String pgenType) {
            super(range, fontName, fontSize, justification, position, rotation,
                    rotationRelativity, text, style, textColor, offset, offset2,
                    mask, outline, pgenCategory, pgenType);
        }
        ...
        public void setLocationOnly(Coordinate loc) {
            if (snapTool != null) {
                super.setLocationOnly(snapTool.latLon2Relative(loc,
                        (Vector) this.getParent().getPrimaryDE()));
            } else {
        ...
        public Coordinate getLocation() {
            if (snapTool != null) {
                return snapTool.relative2LatLon(super.getLocation(),
                        (Vector) this.getParent().getPrimaryDE());
            }
        ...
        public JetText copy() {
             ...
             */
            newText.setColors(
                    new Color[] { new Color(this.getColors()[0].getRed(),
