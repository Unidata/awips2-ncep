...
public class MidCloudText extends Text implements IMidCloudText {
    ...
    public MidCloudText(Coordinate[] range, String fontName, float fontSize,
            ...
            String tstormTypes, String tstormLevels, FontStyle style,
            Color textColor, String pgenCategory, String pgenType) {
    ...
    /**
     * @param cloudAmounts
     *            the cloudAmounts to set
     */
    /*
     * public void setCloudAmounts(String cloudAmounts) { this.cloudAmounts =
     * cloudAmounts; }
     */
    /**
    ...
    /**
     * @param turbulencePattern
     *            the turbulencePattern to set
     */
    ...
    /**
     * @param turbulenceLevels
     *            the turbulenceLevels to set
     */
