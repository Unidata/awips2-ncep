        ...
        public boolean handleMouseMove(int x, int y) {
            ...
            if (attrDlg.isAddLineMode()) {
                ...
                if (labeledLine.getPgenType().equalsIgnoreCase("Cloud")) {
                    lineType = "SCALLOPED";
                } else if (labeledLine.getPgenType().equalsIgnoreCase(
                        "Turbulence")) {
        ...
        public boolean handleMouseDownMove(int x, int y, int button) {
            ...
            if (button == 1) {
                ...
                if (drawingLayer.getDistance(elSelected, loc) > 30
                    ...
                    if (firstDown != null
                            && drawingLayer.getDistance(elSelected, firstDown) < 30) {
                        firstDown = null;
                    } else {
                        return false;
                    }
            ...
            if (button == 1 && drawingLayer != null) {
                ...
                if (elSelected != null) {
                    ...
                    if (elSelected instanceof SinglePointElement) {
                        ...
                        if (elSelected.getParent() instanceof Label) {
                            ...
                            mergedLine = PgenUtil
                                    .mergeLabels(
                                            newll,
                                            newll.getLabelAt(((SinglePointElement) elSelected)
                                                    .getLocation()),
                                            ((SinglePointElement) elSelected)
                                                    .getLocation(), mapEditor,
                                            drawingLayer);
                        }
                    }
                    ...
                    if (elSelected.getParent() instanceof Label) {
                        ...
                        ptSelected2 = false;
                        // modify line
                        DrawableElement el = drawingLayer.getNearestElement(
                                click, newll);
                        // el should be a line
                        if (el instanceof Line) {
                            ((Line) el).setPoints(ghostEl.getPoints());
