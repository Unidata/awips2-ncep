...
public class PgenSelectingTool extends AbstractPgenDrawingTool implements
        IJetBarb {
    ...
    protected void activateTool() {
        ...
        if (de instanceof Gfa) { // Added for gfa move text.
            attrDlg = AttrDlgFactory.createAttrDlg(
                    ((Gfa) de).getPgenCategory(), ((Gfa) de).getPgenType(),
            ...
            editor.refresh();
        } else if (de instanceof Contours == false) {
    ...
    public IInputHandler getMouseHandler() {
        ...
        if (this.mouseHandler == null
                || !(this.mouseHandler instanceof PgenSelectHandler) || // e.g.
                                                                        // deleting
                                                                        // barb
                                                                        // when
                                                                        // a jet
                ...
                this.mapEditor != ((PgenSelectHandler) mouseHandler)
                        .getMapEditor()
                || this.drawingLayer != ((PgenSelectHandler) mouseHandler)
                        .getPgenrsc()) {
    ...
    public void setAddingBarbHandler() {
        ...
        setHandler((IInputHandler) new PgenJetBarbAddingHandler(mapEditor,
                drawingLayer, this, ((JetAttrDlg) attrDlg)));
    ...
    public void setDeletingBarbHandler() {
        ...
        setHandler((IInputHandler) new PgenJetBarbDeletingHandler(mapEditor,
                drawingLayer, this, ((JetAttrDlg) attrDlg)));
    ...
    public void setAddingHashHandler() {
        ...
        setHandler((IInputHandler) new PgenJetHashAddingHandler(mapEditor,
                drawingLayer, this, ((JetAttrDlg) attrDlg)));
    ...
    public void setDeletingHashHandler() {
        ...
        setHandler((IInputHandler) new PgenJetHashDeletingHandler(mapEditor,
                drawingLayer, this, ((JetAttrDlg) attrDlg)));
    ...
    public void changeSelectedLineType(String type) {
        ...
        if (currentDe != null
                && (currentDe.getPgenCategory().equalsIgnoreCase("Lines") || currentDe
                        .getPgenCategory().equalsIgnoreCase("Front"))) {

            AttrDlg dlg = AttrDlgFactory.createAttrDlg(
                    currentDe.getPgenCategory(), type, PlatformUI
