...
public class PgenWatchBoxModifyTool extends PgenSelectingTool {
    ...
    protected void activateTool() {
        ...
        if (event.getTrigger() instanceof WatchBox) {
            ...
            if (drawingLayer.getSelectedDE() == null) {
                drawingLayer.setSelected(((WatchBoxAttrDlg) attrDlg)
                        .getWatchBox());
                ((WatchBoxAttrDlg) attrDlg)
                        .setAttrForDlg(((WatchBoxAttrDlg) attrDlg)
                                .getWatchBox());
    ...
    private class PgenWatchBoxModifyHandler extends PgenSelectHandler {
        ...
        public PgenWatchBoxModifyHandler(AbstractPgenTool tool,
                AbstractEditor mapEditor, PgenResource resource, AttrDlg attrDlg) {
        ...
        public boolean handleMouseDownMove(int x, int y, int button) {
            ...
            if (tmpEl != null && (tmpEl instanceof WatchBox)) {
                ...
                if (!ptSelected) {
                    ...
                    ghostEl.setPoints(((WatchBox) tmpEl).createNewWatchBox(
                            ptIndex, loc,
     ...
     */
    public static boolean resnapWatchBox(AbstractEditor editor,
            WatchBox oldBox, WatchBox newBox) {
        ...
        if (anchorsInPoly == null || anchorsInPoly.isEmpty()) {
            MessageDialog infoDlg = new MessageDialog(PlatformUI.getWorkbench()
                    .getActiveWorkbenchWindow().getShell(), "Information",
                    null, "No anchor point in the area!",
            ...
            if (anchor1 != null && anchor2 != null) {
                ...
                watchPts = WatchBox.generateWatchBoxPts(newBox
                        .getWatchBoxShape(), oldBox.getHalfWidth(), WatchBox
                        .snapOnAnchor(anchor1, oldBox.getPoints().get(0)),
                        WatchBox.snapOnAnchor(anchor2, oldBox.getPoints()
                                .get(4)));
