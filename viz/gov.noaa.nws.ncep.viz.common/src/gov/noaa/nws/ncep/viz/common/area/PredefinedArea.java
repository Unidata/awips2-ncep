 ...
 * serialized to files under localization control.
 * 
 * <pre>
 * 
 *    SOFTWARE HISTORY
...
public class PredefinedArea implements ISerializableObject,
    ...
    @XmlElement
    protected boolean zoomDisable = false;
    ...
    public boolean getZoomDisable() {
        return zoomDisable;
    }

    public void setZoomDisable(boolean zoomDisable) {
        this.zoomDisable = zoomDisable;
    }
    ...
    public static boolean areAreasEqual(PredefinedArea p1, PredefinedArea p2) {
        ...
        try {
            if (p1zlStr
                    .equals(IGridGeometryProvider.ZoomLevelStrings.FitToScreen
                            .toString())) {
                p1zlvl = -1.0;
            } else if (p1zlStr
                    .equals(IGridGeometryProvider.ZoomLevelStrings.SizeOfImage
                            .toString())) {
                p1zlvl = -2.0;
            } else {
            ...
            statusHandler.handle(Priority.PROBLEM,
                    "Error Comparing PredefinedAreas", nfe);
            return false;
        }
