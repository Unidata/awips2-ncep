 ...
 * ------------- -------- ---------- ---------------------------------------
 * Feb 16, 2011  408      Greg Hull  Created.
...
/*
 * TODO: replace entire class with SWT provided calendar widget of some sort
 */
public class CalendarSelectDialog extends Dialog {

    private Shell shell = null;

    // use mainly to save the time zone
    ...
    public DataTime open(DataTime initDateTime) {
        ...
        shell.setText("Select Date/Time ("
                + initCal.getTimeZone().getDisplayName(false, TimeZone.SHORT)
                + ")");
        ...
        monCombo.setItems(new String[] { "Jan", "Feb", "Mar", "Apr", "May",
        ...
        Spinner yrSpnr = new Spinner(yrMonComp, SWT.BORDER);
        ...
        Spinner hrsSpnr = new Spinner(minHrsComp, SWT.BORDER);
        fd = new FormData();
        ...
        Spinner minsSpnr = new Spinner(minHrsComp, SWT.BORDER);
        fd = new FormData();
    ...
    public void updateSelectedDate() {
        ...
        seldDateTxt.setText(
                NmapCommon.getTimeStringFromDataTime(seldDataTime, "/"));
    }
}