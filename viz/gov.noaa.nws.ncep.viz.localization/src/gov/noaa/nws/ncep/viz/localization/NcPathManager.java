 ...
 * May 22, 2018 20492   mgamazaychikov  Renamed references to nlist and sup file names.
 *
 *
 * </pre>
 *
...
public class NcPathManager {
    ...
    public static class NcPathConstants {
        ...
        public static final String AREA_MENUS_FILE = PREDEFINED_AREAS_DIR + File.separator + "menus" + File.separator
                + "AreaMenus.xml";
        ...
        public static final String DFLT_NTRANS_RBD = NCEP_ROOT + "DefaultRBDs" + File.separator
                + "defaultNTransRBD.xml";

        public static final String DFLT_SOLAR_RBD = NCEP_ROOT + "DefaultRBDs" + File.separator + "defaultSolarRBD.xml";

        public static final String DFLT_GRAPH_RBD = NCEP_ROOT + "DefaultRBDs" + File.separator + "defaultGraphRBD.xml";

        public static final String DFLT_RTKP_RBD = NCEP_ROOT + "DefaultRBDs" + File.separator + "defaultRTKpRBD.xml";
        ...
        public static final String LOOP_SPEEDS_TBL = NCEP_ROOT + "LoopControls" + File.separator + "loopSpeeds.tbl";

        public static final String LOCKED_CMAP_TBL = NcPathConstants.COLORMAPS_DIR + File.separator
                + "lockedColorMaps.tbl";

        public static final String CURSOR_REFS_TBL = CURSORS_DIR + File.separator + "cursorref_tbl.xml";

        public static final String CLOUD_HEIGHT_SOUNDING_MODELS = NCEP_ROOT + "CloudHeight" + File.separator
                + "SoundingModels.xml";

        public static final String GEOG_TBL = PREDEFINED_AREAS_DIR + File.separator + "gempak" + File.separator
                + "geog.xml";
        ...
        public static final String CONDITIONAL_FILTER_HELP_FILE = NCEP_ROOT + File.separator + "conditionalFilter"
                + File.separator + "ConditionalFilterHelp.txt";

        public static final String CONDITIONAL_FILTER_MINUS_IMG = NCEP_ROOT + File.separator + "conditionalFilter"
                + File.separator + "minus_red.gif";

        public static final String CONDITIONAL_FILTER_PLUS_IMG = NCEP_ROOT + File.separator + "conditionalFilter"
                + File.separator + "plus_green.gif";

        public static final String ADVANCED_ICON_IMG = NCEP_ROOT + File.separator + "advanced" + File.separator
                + "adv_icon.jpg";
        ...
        public static final String MODIS_IMG_STYLE_RULES = STYLE_RULES_DIR + "modisSatelliteImageryStyleRules.xml";
        ...
        public static final String PGEN_GFA_PROD_XSL = PGEN_ROOT + "xslt" + File.separator + "airmet" + File.separator
                + "gfa_product.xsl";
        ...
        public static final String PGEN_FIR_BOUNDS = SHAPEFILES_DIR + File.separator + "firbnds" + File.separator
                + "firbnds.shp";

        public static final String PGEN_CCFP_TIMES = PGEN_ROOT + "ccfpTimes.xml";

        public static final String PGEN_CCFP_XSLT = PGEN_ROOT + "xslt" + File.separator + "ccfp" + File.separator
                + "ccfpXml2Txt.xslt";

        public static final String PGEN_VAA_FILE = PGEN_ROOT + "vaa.xml";

        public static final String PGEN_VAA_XSLT = PGEN_ROOT + "xslt" + File.separator + "vaa" + File.separator
                + "vaaXml2Txt.xslt";
        ...
        public static final String NSHARP_HAILDATA_FILE = NCEP_ROOT + "nsharp" + File.separator
                + "historicHailData.txt";

        public static final String NSHARP_SUPERCELLDATA_FILE = NCEP_ROOT + "nsharp" + File.separator
                + "historicSupercellData.txt";
        ...
        public static final String XAXIS_SCALE_DIR = TIME_SERIES_DIR + File.separator + "xAxisScales";

        public static final String XAXIS_SCALE_HELP_FILE = XAXIS_SCALE_DIR + File.separator + "XAxisScalesHelp.txt";

        public static final String LCL_RDA_DIR = NCEP_ROOT + "localRadarStations";

        public static final String SATELLITE_AREAS_DIR = NCEP_ROOT + "satelliteAreas";

        public static final String SATELLITE_NAMES_DIR = NCEP_ROOT + "satelliteNames";

        public static final String SATELLITE_IMAGETYPES_DIR = NCEP_ROOT + "satelliteImageTypes";
    ...
    public LocalizationFile getLocalizationFile(LocalizationContext context, String name) {
     ...
     * @return Map
     */
    public Map<String, LocalizationFile> listFiles(String name, String[] filter, boolean recursive, boolean filesOnly) {
        ...
        List<LocalizationFile> lFilesList = Arrays
                .asList(pathMngr.listFiles(contexts, name, filter, recursive, filesOnly));
    ...
    public LocalizationContext getContext(LocalizationType type, LocalizationLevel level) {
