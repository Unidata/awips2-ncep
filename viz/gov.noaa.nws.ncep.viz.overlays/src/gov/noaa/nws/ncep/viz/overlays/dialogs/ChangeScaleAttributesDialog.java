...
public class ChangeScaleAttributesDialog extends
     ...
     * @param dialogTitle
     */
    public ChangeScaleAttributesDialog(Shell parentShell,
    ...
    public Composite createDialog(Composite composite) {
        ...
        scaleEffectiveLatitudeValue = editedRscAttrSet
                .getRscAttr("scaleEffectiveLatitudeValue");
        ...
        if (scalePosition.getAttrClass() != Integer.class) {
            statusHandler.error("scalePosition is not of expected class? "
                    + scalePosition.getAttrClass().toString());
        } else if (scaleUnit.getAttrClass() != Integer.class) {
            statusHandler.error("scaleUnit is not of expected class? "
                    + scaleUnit.getAttrClass().toString());
        } else if (scaleIntervalMode.getAttrClass() != Integer.class) {
            statusHandler.error("scaleIntervalMode is not of expected class? "
                    + scaleIntervalMode.getAttrClass().toString());
        } else if (scaleIntervalValue.getAttrClass() != Integer.class) {
            statusHandler.error("scaleIntervalValue is not of expected class? "
                    + scaleIntervalValue.getAttrClass().toString());
        } else if (scaleLatMode.getAttrClass() != Integer.class) {
            statusHandler.error("scaleLatMode is not of expected class? "
                    + scaleLatMode.getAttrClass().toString());
        } else if (scaleEffectiveLatitudeValue.getAttrClass() != Integer.class) {
            statusHandler
                    .error("scaleEffectiveLatitudeValue is not of expected class? "
                            + scaleEffectiveLatitudeValue.getAttrClass()
                                    .toString());
        } else if (scaleTextFont.getAttrClass() != Integer.class) {
            statusHandler.error("scaleTextFont is not of expected class? "
                    + scaleTextFont.getAttrClass().toString());
        } else if (scaleTextSize.getAttrClass() != Integer.class) {
            statusHandler.error("scaleTextSize is not of expected class? "
                    + scaleTextSize.getAttrClass().toString());
        } else if (scaleTextStyle.getAttrClass() != Integer.class) {
            statusHandler.error("scaleTextStyle is not of expected class? "
                    + scaleTextStyle.getAttrClass().toString());
        } else if (color.getAttrClass() != RGB.class) {
            statusHandler.error("color is not of expected class? "
                    + scaleTextStyle.getAttrClass().toString());
        }
        ...
        valueText.setText(String.valueOf(scaleIntervalValue.getAttrValue()));
        ...
        latitudeText.setText(String.valueOf(scaleEffectiveLatitudeValue
                .getAttrValue()));
        ...
        fontCombo = new Combo(selectTextAttributesGroup, SWT.DROP_DOWN
                | SWT.READ_ONLY);
        ...
        sizeCombo = new Combo(selectTextAttributesGroup, SWT.DROP_DOWN
                | SWT.READ_ONLY);
        ...
        styleCombo = new Combo(selectTextAttributesGroup, SWT.DROP_DOWN
                | SWT.READ_ONLY);
