...
public class PointOverlayAttributesDialog extends
    ...
    /*
     * Just initialize each to a 'neutral' default state on dialog creation;
     * typically the caller will later use setter methods to apply particular
     * defaults before opening the dialog.
     */
    ...
    private File applyZoomImageFile = NcPathManager.getInstance()
            .getStaticFile("ncep/icons/icon_zoom.gif");

    public PointOverlayAttributesDialog(Shell parentShell,
    ...
    public Composite createDialog(Composite composite) {
        ...
        // Get the set of attributes from AbstractEditResourceAttrsDialog and
        // check that all the
        ...
        maxMarkerDisplayWidth = editedRscAttrSet
                .getRscAttr("maxSymbolDisplayWidth");
        maxLabelDisplayWidth = editedRscAttrSet
                .getRscAttr("maxLabelDisplayWidth");
        ...
        if (markerState == null
            ...
            statusHandler
                    .error("markerState is null or not of expected class?");
        }
        ...
        selectMarkerSizeSlider.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent event) {
                markerSize.setAttrValue((float) selectMarkerSizeSlider
                        .getSelection() / 10);
                selectMarkerSizeSliderText.setText(markerSize.getAttrValue()
                        .toString());
                selectMarkerSizeSliderText.redraw();
                selectMarkerSizeSliderText.update();
            }
        });
        selectMarkerSizeSliderText
                .setText(markerSize.getAttrValue().toString());
        ...
        selectMarkerWidthSlider.setSelection((Integer) markerWidth
                .getAttrValue());
        selectMarkerWidthSlider.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent event) {
                ...
                markerWidth.setAttrValue(selectMarkerWidthSlider.getSelection());
            }
        });
        ...
        final Combo selectMarkerTextSizeCombo = new Combo(
                selectMarkerTextSizeGroup, SWT.DROP_DOWN | SWT.READ_ONLY);
        ...
        selectMarkerTextSizeCombo.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent event) {
                selMarkerTextSize = MarkerTextSize.values()[selectMarkerTextSizeCombo
                        .getSelectionIndex()];
                markerTextSize.setAttrValue(selMarkerTextSize);
            }
        });

        // Display Thresholds for Markers and Labels

        final Label maxMarkerDisplayWidthSliderText = new Label(
                markerZoomLevelGrp, SWT.NONE);
        ...
        Button markerApplyCurZoomLvlBtn = new Button(markerZoomLevelGrp,
                SWT.PUSH);
        gridData3 = new GridData();
        gridData3.heightHint = 26;
        gridData3.widthHint = 25;
        gridData3.horizontalIndent = 10;
        markerApplyCurZoomLvlBtn.setImage(new Image(Display.getCurrent(),
                applyZoomImageFile.getAbsolutePath()));
        markerApplyCurZoomLvlBtn.setToolTipText("Set to Current Map Width");
        markerApplyCurZoomLvlBtn.setLayoutData(gridData3);

        final Slider maxMarkerDisplayWidthSlider = new Slider(
                markerZoomLevelGrp, SWT.HORIZONTAL);
        gridData3 = new GridData(GridData.HORIZONTAL_ALIGN_CENTER);
        maxMarkerDisplayWidthSlider
                .setToolTipText("Markers will only be displayed if the width in kilometers\n"
        ...
        Integer markerDispWidth = (Integer) maxMarkerDisplayWidth
                .getAttrValue();
        ...
        maxMarkerDisplayWidthSlider
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent event) {
                        maxMarkerDisplayWidth
                                .setAttrValue((maxMarkerDisplayWidthSlider
                                        .getSelection()));
                        maxMarkerDisplayWidthSliderText
                                .setText(maxMarkerDisplayWidth.getAttrValue()
                                        .toString() + " km");
        ...
        maxMarkerDisplayWidthSliderText.setText(maxMarkerDisplayWidth
                .getAttrValue().toString() + " km");
        ...
        markerApplyCurZoomLvlBtn.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                Double currMapWidth = dispPane.getZoomLevel()
                        * ((MapDescriptor) dispPane.getDescriptor())
                                .getMapWidth() / 1000.0;
                ...
                maxMarkerDisplayWidthSliderText.redraw();
                maxMarkerDisplayWidthSliderText.update();
                maxMarkerDisplayWidthSlider.setSelection(currMapWidth
                        .intValue());
            }
        });

        final Label maxLabelDisplayWidthSliderText = new Label(lblZoomLevelGrp,
                SWT.NONE);
        /* GridData */gridData3 = new GridData();
        gridData3.horizontalIndent = 100;
        gridData3.horizontalAlignment = GridData.FILL;
        ...
        gridData3.widthHint = 25;
        gridData3.horizontalIndent = 10;
        applyCurZoomLvlBtn.setImage(new Image(Display.getCurrent(),
                applyZoomImageFile.getAbsolutePath()));
        applyCurZoomLvlBtn.setToolTipText("Set to Current Map Width");
        applyCurZoomLvlBtn.setLayoutData(gridData3);

        final Slider maxLabelDisplayWidthSlider = new Slider(lblZoomLevelGrp,
                SWT.HORIZONTAL);
        gridData3 = new GridData(GridData.HORIZONTAL_ALIGN_CENTER);
        maxLabelDisplayWidthSlider
                .setToolTipText("Labels will only be displayed if the width in\n"
        ...
        maxLabelDisplayWidthSlider.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent event) {
                maxLabelDisplayWidth.setAttrValue((maxLabelDisplayWidthSlider
                        .getSelection()));
                maxLabelDisplayWidthSliderText.setText(maxLabelDisplayWidth
                        .getAttrValue().toString() + " km");
        ...
        Button markerPlusTextButton = new Button(selectMarkerStateGroup,
                SWT.RADIO);
