...
public class EditWstmAttrDialog extends AbstractEditResourceAttrsDialog {
    ...
    public enum MarkerSelectionPanelIdentifier {
    ...
    public Composite createDialog(Composite topComp) {
        ...
        wstmWarningCheckBox.setSelection((Boolean) wstmWarningEnableAttr
                .getAttrValue());
        wstmWarningCheckBox.addSelectionListener(new SelectionAdapter() {

            @Override
            public void widgetSelected(SelectionEvent e) {
                wstmWarningEnableAttr.setAttrValue(wstmWarningCheckBox
                        .getSelection());
            }
        });

        wstmWarningColorButtonSelector = drawColorButtonSelector(gridComp);
        wstmWarningColorButtonSelector.setColorValue((RGB) wstmWarningColorAttr
                .getAttrValue());
        wstmWarningColorButtonSelector
        ...
        wstmWarningLineWidthSpinner = drawSpinnerWithLabel(gridComp,
                lineWidthTxt);
        wstmWarningLineWidthSpinner
                .setSelection((Integer) (wstmWarningLineWidthAttr
                        .getAttrValue()));
        wstmWarningLineWidthSpinner
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
                        wstmWarningLineWidthAttr
                                .setAttrValue(wstmWarningLineWidthSpinner
                                        .getSelection());
                    }
                });

        wstmWarningSymbolWidthSpinner = drawSpinnerWithLabel(gridComp,
                symbolWidthTxt);
        wstmWarningSymbolWidthSpinner
                .setSelection((Integer) (wstmWarningSymbolWidthAttr
                        .getAttrValue()));
        wstmWarningSymbolWidthSpinner
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
                        wstmWarningSymbolWidthAttr
                                .setAttrValue(wstmWarningSymbolWidthSpinner
                                        .getSelection());
                    }
                });

        wstmWarningSymbolSizeSpinner = drawSpinnerWithLabel(gridComp,
                symbolSizeTxt);
        scale = (float) Math.pow(10, wstmWarningSymbolSizeSpinner.getDigits());

        warningSymbolSize = Math.round(scale
                * ((Float) wstmWarningSymbolSizeAttr.getAttrValue())
                        .floatValue());
        wstmWarningSymbolSizeSpinner.setSelection(warningSymbolSize);
        wstmWarningSymbolSizeSpinner
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
                        float scale2 = (float) Math.pow(10,
                                wstmWarningSymbolSizeSpinner.getDigits());
                        wstmWarningSymbolSizeAttr.setAttrValue(new Float(
                                (wstmWarningSymbolSizeSpinner.getSelection())
                                        / scale2));
                    }
                });

        Button markerWstmWarningButton = drawMarkerSelectionButtonAndItsLabel(
                gridComp, warningMarkerData);
        markerWstmWarningButton.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent event) {
                openMarkerSelectionPanel((Button) event.widget,
                        MarkerSelectionPanelIdentifier.PANEL1);
            }
        });

        wstmWatchCheckBox = drawCheckBox(gridComp);
        wstmWatchCheckBox.setText("Winter Storm Watch");
        wstmWatchCheckBox.setSelection((Boolean) wstmWatchEnableAttr
                .getAttrValue());
        wstmWatchCheckBox.addSelectionListener(new SelectionAdapter() {

            @Override
            public void widgetSelected(SelectionEvent e) {
                wstmWatchEnableAttr.setAttrValue(wstmWatchCheckBox
                        .getSelection());
            }
        });

        wstmWatchColorButtonSelector = drawColorButtonSelector(gridComp);
        wstmWatchColorButtonSelector.setColorValue((RGB) wstmWatchColorAttr
                .getAttrValue());
        ...
        wstmWatchLineWidthSpinner
                .setSelection((Integer) (wstmWatchLineWidthAttr.getAttrValue()));
        wstmWatchLineWidthSpinner.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
                wstmWatchLineWidthAttr.setAttrValue(wstmWatchLineWidthSpinner
                        .getSelection());
            }
        });

        wstmWatchSymbolWidthSpinner = drawSpinnerWithLabel(gridComp,
                symbolWidthTxt);
        wstmWatchSymbolWidthSpinner
                .setSelection((Integer) (wstmWatchSymbolWidthAttr
                        .getAttrValue()));
        wstmWatchSymbolWidthSpinner
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
                        wstmWatchSymbolWidthAttr
                                .setAttrValue(wstmWatchSymbolWidthSpinner
                                        .getSelection());
                    }
                });

        wstmWatchSymbolSizeSpinner = drawSpinnerWithLabel(gridComp,
                symbolSizeTxt);
        scale = (float) Math.pow(10, wstmWatchSymbolSizeSpinner.getDigits());

        watchSymbolSize = Math
                .round(scale
                        * ((Float) wstmWatchSymbolSizeAttr.getAttrValue())
                                .floatValue());
        ...
        wstmWatchSymbolSizeSpinner.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                float scale2 = (float) Math.pow(10,
                        wstmWatchSymbolSizeSpinner.getDigits());
                wstmWatchSymbolSizeAttr.setAttrValue(new Float(
                        (wstmWatchSymbolSizeSpinner.getSelection()) / scale2));
            }
        });

        Button markerWstmWatchButton = drawMarkerSelectionButtonAndItsLabel(
                gridComp, watchMarkerData);
        markerWstmWatchButton.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent event) {
                openMarkerSelectionPanel((Button) event.widget,
                        MarkerSelectionPanelIdentifier.PANEL2);
            }
        });

        wstmAdvisoryCheckBox = drawCheckBox(gridComp);
        wstmAdvisoryCheckBox.setText("Winter Weather Advisory");
        wstmAdvisoryCheckBox.setSelection((Boolean) wstmAdvisoryEnableAttr
                .getAttrValue());
        wstmAdvisoryCheckBox.addSelectionListener(new SelectionAdapter() {

            @Override
            public void widgetSelected(SelectionEvent e) {
                wstmAdvisoryEnableAttr.setAttrValue(wstmAdvisoryCheckBox
                        .getSelection());
            }
        });

        wstmAdvisoryColorButtonSelector = drawColorButtonSelector(gridComp);
        wstmAdvisoryColorButtonSelector
                .setColorValue((RGB) wstmAdvisoryColorAttr.getAttrValue());
        wstmAdvisoryColorButtonSelector
                .addListener(new IPropertyChangeListener() {
                    @Override
                    public void propertyChange(PropertyChangeEvent event) {
        ...
        wstmAdvisoryLineWidthSpinner = drawSpinnerWithLabel(gridComp,
                lineWidthTxt);
        wstmAdvisoryLineWidthSpinner
                .setSelection((Integer) (wstmAdvisoryLineWidthAttr
                        .getAttrValue()));
        wstmAdvisoryLineWidthSpinner
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
                        wstmAdvisoryLineWidthAttr
                                .setAttrValue(wstmAdvisoryLineWidthSpinner
                                        .getSelection());
                    }
                });

        wstmAdvisorySymbolWidthSpinner = drawSpinnerWithLabel(gridComp,
                symbolWidthTxt);
        wstmAdvisorySymbolWidthSpinner
                .setSelection((Integer) (wstmAdvisorySymbolWidthAttr
                        .getAttrValue()));
        wstmAdvisorySymbolWidthSpinner
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
                        wstmAdvisorySymbolWidthAttr
                                .setAttrValue(wstmAdvisorySymbolWidthSpinner
                                        .getSelection());
                    }
                });

        wstmAdvisorySymbolSizeSpinner = drawSpinnerWithLabel(gridComp,
                symbolSizeTxt);
        scale = (float) Math.pow(10, wstmAdvisorySymbolSizeSpinner.getDigits());

        advisorySymbolSize = Math.round(scale
                * ((Float) wstmAdvisorySymbolSizeAttr.getAttrValue())
                        .floatValue());
        wstmAdvisorySymbolSizeSpinner.setSelection(advisorySymbolSize);
        wstmAdvisorySymbolSizeSpinner
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
                        float scale2 = (float) Math.pow(10,
                                wstmAdvisorySymbolSizeSpinner.getDigits());
                        wstmAdvisorySymbolSizeAttr.setAttrValue(new Float(
                                (wstmAdvisorySymbolSizeSpinner.getSelection())
                                        / scale2));
                    }
                });

        Button markerWstmAdvisoryButton = drawMarkerSelectionButtonAndItsLabel(
                gridComp, advisoryMarkerData);
        markerWstmAdvisoryButton.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent event) {
                // bData = (String)(((Button)event.widget).getData());
                openMarkerSelectionPanel((Button) event.widget,
                        MarkerSelectionPanelIdentifier.PANEL3);
            }
        });
        ...
        /*
         * A separate grid layout to align the 3 check-boxes in a single column
         * below the separator
         */
        ...
        wstmZoneCheckBox.setSelection((Boolean) zoneNameEnableAttr
                .getAttrValue());
        ...
        wstmOutlineCheckBox.setSelection((Boolean) outlineEnableAttr
                .getAttrValue());
        wstmOutlineCheckBox.addSelectionListener(new SelectionAdapter() {

            @Override
            public void widgetSelected(SelectionEvent e) {
                outlineEnableAttr.setAttrValue(wstmOutlineCheckBox
                        .getSelection());
            }
        });
     ...
     */
    private Spinner drawSpinnerWithLabel(Composite parentComposite,
            String labelText) {
     ...
     * @return
     */
    private ColorButtonSelector drawColorButtonSelector(
        ...
        final ColorButtonSelector colorSel = new ColorButtonSelector(colComp,
                50, 20);
        return colorSel;
    }
     ...
     * Sets the icon on the button to the icon selected by the user from the
     * MarkerSelectionPanel
     * 
     * @param parentComposite
     * @return
     */
    private Button drawMarkerSelectionButtonAndItsLabel(
            Composite parentComposite, String dataToSet) {
        ...
        if (MarkerSelectionPanel.getImageMap() != null
                && MarkerSelectionPanel.getImageMap().size() > 0) {
            iconPath = new String(MarkerSelectionPanel.getImageMap().get(
                    dataToSet));
        }
    ...
    private void checkAttributeValues() {
        wstmWarningEnableAttr = editedRscAttrSet
                .getRscAttr("wstmWarningEnable");
        wstmWarningColorAttr = editedRscAttrSet.getRscAttr("wstmWarningColor");
        wstmWarningLineWidthAttr = editedRscAttrSet
                .getRscAttr("wstmWarningLineWidth");
        wstmWarningSymbolWidthAttr = editedRscAttrSet
                .getRscAttr("wstmWarningSymbolWidth");
        wstmWarningSymbolSizeAttr = editedRscAttrSet
                .getRscAttr("wstmWarningSymbolSize");
        ...
        wstmWatchLineWidthAttr = editedRscAttrSet
                .getRscAttr("wstmWatchLineWidth");
        wstmWatchSymbolWidthAttr = editedRscAttrSet
                .getRscAttr("wstmWatchSymbolWidth");
        wstmWatchSymbolSizeAttr = editedRscAttrSet
                .getRscAttr("wstmWatchSymbolSize");

        wstmAdvisoryEnableAttr = editedRscAttrSet
                .getRscAttr("wstmAdvisoryEnable");
        wstmAdvisoryColorAttr = editedRscAttrSet
                .getRscAttr("wstmAdvisoryColor");
        wstmAdvisoryLineWidthAttr = editedRscAttrSet
                .getRscAttr("wstmAdvisoryLineWidth");
        wstmAdvisorySymbolWidthAttr = editedRscAttrSet
                .getRscAttr("wstmAdvisorySymbolWidth");
        wstmAdvisorySymbolSizeAttr = editedRscAttrSet
                .getRscAttr("wstmAdvisorySymbolSize");
        ...
        if (wstmWarningEnableAttr.getAttrClass() != Boolean.class) {
            System.out
                    .println("Error: wstmWarningEnableAttr is not of expected class Boolean");
        }
        ...
        if (wstmWarningColorAttr.getAttrClass() != RGB.class) {
            System.out
                    .println("Error: wstmWarningColorAttr is not of expected class RGB");
        }
        ...
        if (wstmWarningLineWidthAttr.getAttrClass() != Integer.class) {
            System.out
                    .println("Error: wstmWarningLineWidthAttr is not of expected class Integer");
        }
        ...
        if (wstmWarningSymbolWidthAttr.getAttrClass() != Integer.class) {
            System.out
                    .println("Error: wstmWarningSymbolWidthAttr is not of expected class Integer");
        }
        ...
        if (wstmWarningSymbolSizeAttr.getAttrClass() != Float.class) {
            System.out
                    .println("Error: wstmWarningSymbolSizeAttr is not of expected class Float");
        }
        ...
        if (wstmWatchEnableAttr.getAttrClass() != Boolean.class) {
            System.out
                    .println("Error: wstmWatchEnableAttr is not of expected class Boolean");
        }
        ...
        if (wstmWatchColorAttr.getAttrClass() != RGB.class) {
            System.out
                    .println("Error: wstmWatchColorAttr is not of expected class RGB");
        }
        ...
        if (wstmWatchLineWidthAttr.getAttrClass() != Integer.class) {
            System.out
                    .println("Error: wstmWatchLineWidthAttr is not of expected class Integer");
        }
        ...
        if (wstmWatchSymbolWidthAttr.getAttrClass() != Integer.class) {
            System.out
                    .println("Error: wstmWatchSymbolWidthAttr is not of expected class Integer");
        }
        ...
        if (wstmWatchSymbolSizeAttr.getAttrClass() != Float.class) {
            System.out
                    .println("Error: wstmWatchSymbolSizeAttr is not of expected class Float");
        }
        ...
        if (wstmAdvisoryEnableAttr.getAttrClass() != Boolean.class) {
            System.out
                    .println("Error: wstmAdvisoryEnableAttr is not of expected class Boolean");
        }
        ...
        if (wstmAdvisoryColorAttr.getAttrClass() != RGB.class) {
            System.out
                    .println("Error: wstmAdvisoryColorAttr is not of expected class RGB");
        }
        ...
        if (wstmAdvisoryLineWidthAttr.getAttrClass() != Integer.class) {
            System.out
                    .println("Error: wstmAdvisoryLineWidthAttr is not of expected class Integer");
        }
        ...
        if (wstmAdvisorySymbolWidthAttr.getAttrClass() != Integer.class) {
            System.out
                    .println("Error: wstmAdvisorySymbolWidthAttr is not of expected class Integer");
        }
        ...
        if (wstmAdvisorySymbolSizeAttr.getAttrClass() != Float.class) {
            System.out
                    .println("Error: wstmAdvisorySymbolSizeAttr is not of expected class Float");
        }
        ...
        if (timeEnableAttr.getAttrClass() != Boolean.class) {
            System.out
                    .println("Error: timeEnableAttr is not of expected class Boolean");
        }
        ...
        if (zoneNameEnableAttr.getAttrClass() != Boolean.class) {
            System.out
                    .println("Error: zoneNameEnableAttr is not of expected class Boolean");
        }
        ...
        if (outlineEnableAttr.getAttrClass() != Boolean.class) {
            System.out
                    .println("Error: outlineEnableAttr is not of expected class Boolean");
        }
     ...
     */
    private void openMarkerSelectionPanel(Button thisButton,
            MarkerSelectionPanelIdentifier markerSelectionPanelId) {

        if (markerSelectionPanelId == MarkerSelectionPanelIdentifier.PANEL1) {
            markerSelectionPanel1 = createOrOpenPanel(markerSelectionPanel1,
                    thisButton);
            if (markerSelectionPanel1 != null && markerSelectionPanel1.close()) {
                warningMarkerData = (String) (markerSelectionPanel1
                        .getActivator().getData());
                // if(warningMarkerData.compareTo( (String)
                // thisButton.getData()) != 0){
                // isWarningMarkerChanged = true;
                // }
            }
        } else if (markerSelectionPanelId == MarkerSelectionPanelIdentifier.PANEL2) {
            markerSelectionPanel2 = createOrOpenPanel(markerSelectionPanel2,
                    thisButton);
            if (markerSelectionPanel2 != null && markerSelectionPanel2.close()) {
                watchMarkerData = (String) (markerSelectionPanel2
                        .getActivator().getData());
            ...
            markerSelectionPanel3 = createOrOpenPanel(markerSelectionPanel3,
                    thisButton);
            if (markerSelectionPanel3 != null && markerSelectionPanel3.close()) {
                advisoryMarkerData = (String) (markerSelectionPanel3
                        .getActivator().getData());
            }
        }
    }
     ...
     * @param thisButton
     */
    private MarkerSelectionPanel createOrOpenPanel(
            MarkerSelectionPanel markerSelectionPanel, Button thisButton) {
     ...
     * 
     * @see
     * gov.noaa.nws.ncep.viz.resources.attributes.AbstractEditResourceAttrsDialog
     * #initWidgets()
     */
    @Override
