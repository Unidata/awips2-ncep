 ...
 * @version 1.0
 */
public class FFGResource
        extends AbstractNatlCntrsResource<FFGResourceData, NCMapDescriptor>
    ...
    private class FrameData extends AbstractFrameData {
        ...
        public boolean updateFrameData(IRscDataObject rscDataObj) {
            if (!(rscDataObj instanceof FFGRscDataObj)) {
                System.out.println(
                        "FFG:updateFrameData expecting FFGRscDataObj instead of: "
            ...
            } else if (timeMatch(rscDataObj.getDataTime()) < timeMatch(
                    existingFfgData.getDataTime())) {
                ffgDataList.put(ffgRscData.zoneId, ffgRscData);
            }
    ...
    protected IRscDataObject[] processRecord(Object pdo) {
        if (!(pdo instanceof FfgRecord)) {
            System.out.println(
                    "FFG processRecord() : Expecting FfgRecord object instead of: "
