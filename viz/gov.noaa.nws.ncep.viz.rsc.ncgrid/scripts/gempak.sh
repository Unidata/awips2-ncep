...
# TODO this is slow, as it starts all standard CAVE bundles, including lots
# we don't need (e.g. spring), which adds a lot of overhead. We need a better
# way than this of starting a subprocess with a valid classpath.
