 ...
 * returning the data URI String. This is done in CAVE.
 *
 * <pre>
 *
 * SOFTWARE HISTORY
 ...
 * @author mapeters
 */
public class GempakDataURIRequestHandler
        implements IGempakRequestHandler<GempakDataURIRequest> {

    private final IGempakDataURIRetriever retriever;
    ...
    @Override
    public String handleRequest(GempakDataURIRequest request)
            throws GempakException {
        return retriever.getDataURI(request);
    }
}
