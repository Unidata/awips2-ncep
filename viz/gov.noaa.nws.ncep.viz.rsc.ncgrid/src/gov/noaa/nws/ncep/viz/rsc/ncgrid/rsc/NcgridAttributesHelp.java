 ...
 * 03/01/2016   R6821        K. Bugenhagen  Added tooltip text for model name, 
 *                                          gparm, and gdattim
 * 
 * @author xguo
 * @version 1
...
public class NcgridAttributesHelp {
    ...
    public static String ModelNameToolTipText() {
        String toolTipText = "Model name string to be saved in the database. \n"
                + "Can not be the same as an existing model name.  No Spaces!";

        return toolTipText;
    }

    public static String GparmToolTipText() {
        String text = "GFUNC and GVECT are the scalar and vector grid functions. They are\n"
    ...
    public static String GdattimToolTipText() {
        String text = "GDATTIM is the date/time for the grid.\n\n"
                +
