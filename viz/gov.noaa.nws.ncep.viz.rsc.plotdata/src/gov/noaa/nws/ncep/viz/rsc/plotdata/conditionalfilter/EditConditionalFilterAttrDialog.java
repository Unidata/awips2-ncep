...
/**
 * UI for temporarily editing Conditional Filter attribute of a Point Data
 * Resource
 * 
 * 
 * <pre>
...
public class EditConditionalFilterAttrDialog extends Dialog {
    ...
    public EditConditionalFilterAttrDialog(Shell parentShell,
    ...
    public void createShell(int x, int y) {
        ...
        Composite editConditionalFilterComp = new EditConditionalFilterComposite(
                shell, SWT.NONE, this.perspective, editedConditionalFilter);
        ...
        revertBtn.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
                ...
                editedConditionalFilter = ConditionalFilterFactory
