...
public class NCLoopProperties extends LoopProperties {
    ...
    public NCLoopProperties(LoopProperties original) {
        ...
        if (original instanceof NCLoopProperties) {
            ...
            minNcepFrameTime = ncOriginal.minNcepFrameTime;
            maxNcepFrameTime = ncOriginal.maxNcepFrameTime;
            ncepFrameStep = ncOriginal.ncepFrameStep;
            ...
            ncepFirstFrameDwellStep = ncOriginal.ncepFirstFrameDwellStep;
            ncepLastFrameDwellStep = ncOriginal.ncepLastFrameDwellStep;
        }
    }
