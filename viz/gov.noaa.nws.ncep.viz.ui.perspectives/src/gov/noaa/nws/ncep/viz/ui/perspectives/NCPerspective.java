...
public class NCPerspective implements IPerspectiveFactory {
    ...
    public void createInitialLayout(IPageLayout layout) {
        ...
        layout.addPlaceholder("gov.noaa.nws.ncep.ui.nsharp.defaultview1", IPageLayout.RIGHT,0.94f, refId);
        layout.addPlaceholder( "gov.noaa.nws.ncep.viz.rsc.timeseries.view.SamplingView",IPageLayout.LEFT, 0.25f, refId);
        layout.addPlaceholder("gov.noaa.nws.ncep.viz.rsc.timeseries.view.KTableView",IPageLayout.BOTTOM, 0.75f, refId);
        layout.addActionSet("gov.noaa.nws.ncep.viz.ui.personalities.NCActionSet");
        layout.addPlaceholder("gov.noaa.nws.ncep.viz.rtkp.GEOMAGRTKPDATABLOCK",IPageLayout.BOTTOM, 0.60f, refId);
        layout.addPlaceholder("gov.noaa.nws.ncep.viz.rtkp.GEOMAGRTKPRECENTKP", IPageLayout.RIGHT, 0.75f, refId);
